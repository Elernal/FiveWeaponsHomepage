...
const imageLoaderMocks = vi.hoisted(() => ({
    getPublicAssetPath: vi.fn((assetPath) => `/FiveWeaponsHomepage/${assetPath}`),
    loadImage: vi.fn()
}));

vi.mock("../src/utils/imageLoader.js", () => imageLoaderMocks);
...
describe("App", () => {
    beforeEach(() => {
        ...
        imageLoaderMocks.loadImage.mockImplementation((path, alt) => {
